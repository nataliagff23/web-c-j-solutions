...
(function () {
  ...
  var T = {
    en: {
      ...
      "portfolio.viewMore": "View Full Gallery →",
      "gallery.title": "Our Work",
      "gallery.sub": "A growing collection of construction and remodeling projects across Jacksonville and Central Florida.",
      ...
      "contact.ctaH": "Call or text us <span class=\"accent\">anytime.</span>",
      "contact.ctaP": "We answer fast during business hours. Prefer texting? Send us a quick message about your project and we'll get back to you the same day.",
      "contact.callBtn": "Call +1 (918) 378-1896",
      "contact.smsBtn": "Send a text message",
      "contact.ctaNote": "Available Monday–Saturday, 7am–7pm",
    ...
    es: {
      ...
      "portfolio.viewMore": "Ver Galería Completa →",
      "gallery.title": "Nuestros Trabajos",
      "gallery.sub": "Una colección creciente de proyectos de construcción y remodelación en Jacksonville y Florida Central.",
      ...
      "contact.ctaH": "Llámanos o envíanos un <span class=\"accent\">mensaje.</span>",
      "contact.ctaP": "Respondemos rápido en horario laboral. ¿Prefieres mensaje de texto? Envíanos los detalles de tu proyecto y te contactamos el mismo día.",
      "contact.callBtn": "Llama +1 (918) 378-1896",
      "contact.smsBtn": "Enviar mensaje de texto",
      "contact.ctaNote": "Disponibles Lunes–Sábado, 7am–7pm",
